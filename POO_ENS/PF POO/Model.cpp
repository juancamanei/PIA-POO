...
Model::Model(GLdouble _rangoX, GLdouble _rangoZ, GLdouble _ox, GLdouble _oy, GLdouble _oz):
	Colision( _rangoX,  _rangoZ,  _ox,  _oy,  _oz)
{
}
...
Model::Model(GLdouble _rangoX, GLdouble _rangoZ, GLdouble _ox, GLdouble _oy, GLdouble _oz,string modelPath,
	string texturePath, bool mode) : textureId(0), Colision( _rangoX,  _rangoZ,  _ox,  _oy,  _oz) {
	if (mode == 0)
